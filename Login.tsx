...
export default function LoginDesign() {
  ...
  // Apenas para testar a animação visual do botão de carregamento
  ...
  const inputStyle: React.CSSProperties = {
    ...
    borderRadius: '12px', color: '#F3F4F6', fontSize: '15px',
  ...
  return (
    <div style={{
      ...
      <div className="card-in" style={{
        ...
        <h2 style={{ margin: '0 0 4px', fontSize: '22px', fontWeight: 700, color: 'var(--text)' }}>Bem-vindo de volta</h2>
